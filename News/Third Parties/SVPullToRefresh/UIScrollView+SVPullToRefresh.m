...
@synthesize wasTriggeredByUser=_wasTriggeredByUser;
@synthesize subtitles=_subtitles;
@synthesize showsDateLabel=_showsDateLabel;
@synthesize viewForState=_viewForState;
...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"اسحب للتحديث....",),//Pull to refresh...",),
                       NSLocalizedString(@"أطلق للتحديث.....",),//Release to refresh...",),
                       NSLocalizedString(@"تحميل....",),//Loading...",),
                                                       nil];
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = NSLocalizedString(@"اسحب للتحديث....",);//Pull to refresh...",);
